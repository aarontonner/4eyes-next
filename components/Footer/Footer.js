      ...
      <div className="cs-container">
        <div className="cs-top">
          ...
          <ul className="cs-ul">
            ...
            <li className="cs-li">
              <a className="cs-link" href="/portfolio">
                Portfolio
              </a>
            </li>
            <li className="cs-li">
              <a className="cs-link" href="/about">
                About
              </a>
            </li>
            <li className="cs-li">
        ...
        <div className="cs-bottom">
          <ul className="cs-social">
            <li className="cs-social-li">
              <a
                href="https://www.facebook.com/4EyesWeddingPhotographer"
            ...
            <li className="cs-social-li">
              <a
                href="https://www.tiktok.com/@4eyesphotography"
                className="cs-social-link"
                aria-label="twitter"
                target="_blank"
                rel="noopener"
            ...
            <li className="cs-social-li">
              <a
                href="https://www.instagram.com/4eyesphotography_/"
                className="cs-social-link"
            ...
            <li className="cs-social-li">
              <a
                href="https://www.google.com/maps/place/4Eyes+Photography/@51.2041043,-114.5066666,17z/data=!3m1!4b1!4m6!3m5!1s0x53713ff21233f119:0xbe78d47ab5f477cf!8m2!3d51.2041043!4d-114.5040917!16s%2Fg%2F11mv5rl61x?entry=ttu"
                className="cs-social-link"
                aria-label="twitter"
                target="_blank"
                rel="noopener"
          ...
          <span className="cs-copyright">
            © Copyright 2024 -{" "}
            <a
              href="https://www.aarontonner.com"
              target="_blank"
              className="cs-copyright-link"
            >
              designed by Aaron Tonner Web Solutions
            </a>
          </span>
