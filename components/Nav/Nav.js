            ...
            <ul id="cs-expanded" className="cs-ul" aria-expanded="false">
              ...
              <li className="cs-li cs-dropdown" tabIndex={0}>
                <span className="cs-li-link">
                  <Link className="cs-li-link inline" href="">
                    Portfolio
                  </Link>
                  <img
                    className="cs-drop-icon inline"
                ...
                <ul className="cs-drop-ul">
                  ...
                  <li className="cs-drop-li">
                    <Link className="cs-li-link cs-drop-link" href="/wedding">
                      Wedding
                    </Link>
                  </li>
                  <li className="cs-drop-li">
              ...
              <li className="cs-li cs-dropdown" tabIndex={0}>
                ...
                <ul className="cs-drop-ul">
                  <li className="cs-drop-li">
                    <a
                      href="/locations/calgary-wedding-photographers"
                      className="cs-li-link cs-drop-link"
                    >
                      Calgary
                    </a>
              ...
              <li className="cs-li cs-dropdown" tabIndex={0}>
                ...
                <ul className="cs-drop-ul">
                  <li className="cs-drop-li">
                    <a href="/about" className="cs-li-link cs-drop-link">
                      About
                    </a>
                  </li>
                  <li className="cs-drop-li">
                    <a href="/investment" className="cs-li-link cs-drop-link">
                      Investment
                    </a>
                  </li>
                  <li className="cs-drop-li">
                  ...
                  <li className="cs-drop-li">
                    <a href="/pricing" className="cs-li-link cs-drop-link">
                      pricing (hidden)
                    </a>
                  </li>
                </ul>
